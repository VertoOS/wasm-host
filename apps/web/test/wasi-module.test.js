...
const UNSUPPORTED_IMPORT_WASM = base64ToBytes(
  "AGFzbQEAAAABCwJgA39+fgF/YAAAAi8BFndhc2lfc25hcHNob3RfcHJldmlldzEUZmRfZmRzdGF0X3NldF9yaWdodHMAAAMCAQEFAwEAAQcTAgZtZW1vcnkCAAZfc3RhcnQAAQoNAQsAQQFCAEIAEAAaCw==",
);
...
test("raw WASI executor reports invalid modules and unsupported imports", async () => {
  ...
  await assert.rejects(
    ...
    (error) => {
      ...
      assert.match(error.message, /fd_fdstat_set_rights/);
      return true;
    },
  );
});
