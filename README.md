...
- The browser adapter package has a deterministic browser-owned app-server
  JSON-RPC fixture and loopback transport for initialize, account read, device
  login cancel, thread start, mocked turn completion, turn interrupt, ordered
  notifications, and structured unsupported capability errors.
