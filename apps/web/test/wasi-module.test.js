...
const WASIX_PROCESS_IMPORTS_WASM = base64ToBytes(
  "",
);
...
const WASIX_TTY_IMPORTS_WASM = base64ToBytes(
  "",
);

const WASIX_TTY_TERMINAL_SIZE_WASM = base64ToBytes(
  "",
);

const WASIX_FD_DUP_PIPE_WASM = base64ToBytes(
  "",
);
...
test("raw WASI worker request carries terminal dimensions as cloneable data", async () => {
  const output = recordingOutput();
  const worker = recordingWasiWorker();
  const executor = createRawWasiModuleWorkerExecutor({
    createWorker: () => worker,
  ...
  assert.deepEqual(result, { exitCode: 0 });
  assert.deepEqual(worker.messages[0].request.terminal, {
    columns: 132,
    height: 600,
    rows: 43,
    width: 800,
...
test("raw WASI executor supplies non-interactive WASIX TTY state", async () => {
  const output = recordingOutput();
  const executor = createRawWasiModuleExecutor({ worker: false });
  const packageRecord = await loadRawWasiModulePackage({
    artifactKind: "wasi-module",
    bytes: WASIX_TTY_IMPORTS_WASM,
    command: "tty-smoke",
    id: "tty-smoke",
  });

  const result = await executor.run(
    { ...baseRunRequest(packageRecord), command: "tty-smoke" },
    output,
  );

  assert.deepEqual(result, { exitCode: 0 });
  assert.equal(output.stdout, "wasix-tty-imports-ok\n");
  assert.equal(output.stderr, "");
});

test("raw WASI executor reports terminal dimensions through WASIX tty_get", async () => {
  const output = recordingOutput();
  const executor = createRawWasiModuleExecutor({ worker: false });
  const packageRecord = await loadRawWasiModulePackage({
    artifactKind: "wasi-module",
    bytes: WASIX_TTY_TERMINAL_SIZE_WASM,
    command: "tty-size-smoke",
    id: "tty-size-smoke",
  });
  ...
  assert.deepEqual(result, { exitCode: 0 });
  assert.equal(output.stdout, "wasix-tty-size-ok\n");
  assert.equal(output.stderr, "");
});
...
test("raw WASI executor supports WASIX fd duplication and pipes", async () => {
  ...
  const packageRecord = await loadRawWasiModulePackage({
    artifactKind: "wasi-module",
    bytes: WASIX_FD_DUP_PIPE_WASM,
    command: "fd-dup-pipe-smoke",
    files: { "dup.txt": "abcdef\n" },
    id: "fd-dup-pipe-smoke",
  });

  const result = await executor.run(
    { ...baseRunRequest(packageRecord), command: "fd-dup-pipe-smoke" },
    output,
  );

  assert.deepEqual(result, { exitCode: 0 });
  assert.equal(output.stdout, "dup-out\nwasix-fd-dup-pipe-ok\n");
  assert.equal(output.stderr, "");
});
